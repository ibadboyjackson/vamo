                ...
                <div class="col-sm-12 portlets">
                    <div class="widget">
                        <div class="widget-header transparent">
                            <h2><strong>Flight</strong> Edit</h2>
                        ...
                        <div class="widget-content padding">
                            <form role="form" id="registerForm" method="post" action="{{ route('admin.flight.update', $flight->id) }}" enctype="multipart/form-data">
                                @csrf
                                @method('PATCH')
                                <div class="form-group">
                                    <label>Nom de la compagnie</label>
                                    <input type="text" class="form-control" name="company_name" value="{{ $flight->company_name }}">
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-sm-6">
                                            ...
                                            <input id="text" type="text" class="form-control" name="from" value="{{ $flight->from}}">
                                        </div>
                                        <div class="col-sm-6">
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-sm-6">
                                            ...
                                            <input type="number" class="form-control" name="child_number" value="{{ $flight->child_number }}">
                                        </div>
                                        <div class="col-sm-6">
                                            <label>Numbre maximun d'adultes</label>
                                            <input type="number" class="form-control" name="adult_number" value="{{ $flight->adult_number }}">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="">Upload Image</label>
                                    <input type="file" name="file" class="form-control" value="{{ $flight->file }}">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-sm-6">
                                            ...
                                            <input type="datetime-local" class="form-control" name="date_depart" value="{{ $flight->date_depart }}">
                                        </div>
                                        <div class="col-sm-6">
                                            <label>Date d'arrivée</label>
                                            <input type="datetime-local" class="form-control" name="date_back" value="{{ $flight->date_back }}">
                                        </div>
                                    </div>
                                </div>
