                ...
                <div class="col-md-12">
                    <div class="widget">
                        <div class="widget-header transparent">
                            <h2><strong>Hotels</strong> Liste</h2>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-8">
                                        <div class="toolbar-btn-action">
                                            <a class="btn btn-success" href="{{ route('admin.hotel.create') }}"><i class="fa fa-plus-circle"></i> Add new</a>
                            ...
                            <div class="table-responsive">
                                <table data-sortable class="table table-hover table-striped">
                                    ...
                                    @foreach($hotels as $hotel)
                                        <tr>
                                            <td>{{ $hotel->id }}</td><td><input type="checkbox" class="rows-check"></td>
                                            ...
                                            <td>{{ $hotel->price }}</td><td><span class="label label-success">Active</span></td>
                                            <td>
                                                <div class="btn-group btn-group-xs">
                                                    <a data-toggle="tooltip" title="delete" class="btn btn-default" href=""><i class="fa fa-trash-o"></i></a>
                                                    <a data-toggle="tooltip" title="Edit" class="btn btn-default" href="{{ route('admin.hotel.edit', $hotel->id) }}"><i class="fa fa-edit"></i></a>
                                                </div>
                                            </td>
                                        </tr>
                                    @endforeach
