                ...
                <div class="col-sm-12 portlets">
                    <div class="widget">
                        <div class="widget-header transparent">
                            <h2><strong>Cruise</strong> Add</h2>
                        ...
                        <div class="widget-content padding">
                            <form role="form" id="registerForm" method="post" action="{{ route('admin.cruise.store') }}" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-sm-6">
                                            ...
                                            <input id="text" type="text" class="form-control" name="from" placeholder="">
                                        </div>
                                        <div class="col-sm-6">
