...
@section('content')
    ...
    <section class="hotel-area2" data-stellar-background-ratio="0.6" style="overflow-x: hidden;">
                                            ...
                                            <div class="col-sm-12 col-sm-offset-1 col-xs-12 col-xs-offset-1" style="
                                                ...
                                                <ul role="tablist" class="nav nav-tabs">
                                                    <li role="presentation" class="tab-btn-wrapper ">
                                                        <a href="index1-2.html#fhotel" aria-controls="fhotel" role="tab" data-toggle="tab" class="tab-btn">
                                                    ...
                                                    <li role="presentation" class="tab-btn-wrapper active ">
                                                        <a href="index1-2.html#flight" aria-controls="flight" role="tab" data-toggle="tab" class="tab-btn" >
                                                            <i class="fa fa-building-o"></i>
                                                            <span class="text">HOTELS</span>
                                                            <span >+</span>
                                                            ...
                                                            <span class="xs">RECHERCHE HOTEL + VOL</span>
                                                        </a>
                                                    </li>
                                                    <li role="presentation" class="tab-btn-wrapper">
                                                        <a href="index1-2.html#cars" aria-controls="cars" role="tab" data-toggle="tab" class="tab-btn" style=" line-height: 2em;">
                                                            <i class="fa fa-building-o"></i>
                                                            <span class="text">HOTELS</span>
                                                            ...
                                                            <span class="xs">RECHERCHE HOTEL + VOL + VOITURE</span>
                                                        </a>
                                                    </li>
                                                    <li role="presentation" class="tab-btn-wrapper">
                                                        <a href="index1-2.html#tours" aria-controls="tours" role="tab" data-toggle="tab" class="tab-btn">
                                                            <i class="fa fa-building-o"></i>
                                                            <span class="text">HOTELS</span>
                                                            <span >+</span>
                                                            <i class="fa fa-car"></i>
                                                            ...
                                                            <span class="xs">RECHERCHE HOTEL + VOITURE</span>
                                                        </a>
                                                    </li>
                                                    ...
                                                    <div class="tab-content">
                                                        ...
                                                        <div role="tabpanel" id="flight" class="tab-pane fade in active">
                                                            <div class="find-widget find-flight-widget widget">
                                                                <div class="row">
                                                                    <div class="col-sm-12 col-sm-offset-0">
                                                                        <h4 class="title-widgets" style=" padding: 0;">RECHERCHE HOTEL + VOL</h4>
                                                        ...
                                                        <div role="tabpanel" id="tours" class="tab-pane fade">
                                                            <div class="find-widget find-tours-widget widget">
                                                                <div class="row">
                                                                    <div class="col-sm-12 col-sm-offset-0">
                                                                        <h4 class="title-widgets" style=" padding: 0;">RECHERCHE HOTEL + VOITURE</h4>
    ...
    <section id="hotel-era" class="tour-places section-padding">
                ...
                <div class="single-place item ">
                    <div class="carousel-card1">
                        <a href="#" style="text-decoration: none;color:#000">
                            <img src="assets/images/carousel-4.png" alt="" class="card-carousel-image"></a>
                            ...
                            <div class="row">
                                <div class="col-md-6 ">
                                    <a href="#" style="text-decoration: none;color:#000">
                                        ...
                                        <div class="nom-hotel">
                                            <p style="font-weight: 900;">Hôtels xxxxxxxxxx</p>
                                        </div>
                                        <div class="place">
                                            <p style=" color:#f1f3ef;background: #000; padding: 6px;width: auto;">
                                                <span class="fa fa-map-marker" style=" color: rgb(0, 155, 0);"></span> Paris</p>
                                        </div>
                                    </a>  </div>
                                <div class="col-md-6" style=" text-align: right;line-height: 1.3em">
                                    <a href="#" style="text-decoration: none;color:#000">
                                        <div class="price">
                                            <p>à partir de</p>
                                            <span style=" color: rgb(0, 209, 0);font-weight:bold; font-size: 14px;line-height: 1em;                                                        ">000€</span></span>


                                        </div>

                                        <div class="log">
                                            <a href="#" class="btn btn-success btn-success-light float-right">Details</a>
                                        </div></a>
                                </div>
                            </div>
                        </div>
                ...
                <div class="single-place item ">
                    <div class="carousel-card1">
                        <a href="#" style="text-decoration: none;color:#000">
                            ...
                            <img src="assets/images/carousel-5.png" class="card-carousel-image"></a>
                        <div class="carousel-card-description">
                            ...
                            <div class="row">
                                <div class="col-md-6 ">
                                    ...
                                    <a href="#" style="text-decoration: none;color:#000">
                                        ...
                                        <div class="place">
                                            <p style=" color:#f1f3ef;background: #000; padding: 6px;width: auto;">
                                                <span class="fa fa-map-marker" style=" color: rgb(0, 155, 0);"></span> Maldives</p>
                                        </div>
                                    </a>  </div>
                                <div class="col-md-6" style=" text-align: right;line-height: 1.3em">
                                    <a href="#" style="text-decoration: none;color:#000">
                ...
                <div class="single-place item ">
                    <div class="carousel-card1">
                        <a href="#" style="text-decoration: none;color:#000">
                            ...
                            <img src="assets/images/carousel-6.png" class="card-carousel-image"></a>
                        <div class="carousel-card-description">
                            ...
                            <div class="row">
                                <div class="col-md-6 ">
                                    <a href="#" style="text-decoration: none;color:#000">
                                        ...
                                        <div class="place">
                                            <p style=" color:#f1f3ef;background: #000; padding: 6px;width: auto;">
                                                <span class="fa fa-map-marker" style=" color: rgb(0, 155, 0);"></span> Marrekech</p>
                                        </div></a>
                                </div>
                                <div class="col-md-6" style=" text-align: right;line-height: 1.3em">
                                    <a href="#" style="text-decoration: none;color:#000">
    ...
    <!-- / END  HOTEL PLACE DESIGN AREA -->
    <!-- start discover -->
    <section class="hotel-sd-area parallax">
        <div class="container">
            <div class="row">
                <div class="col-sm-10 col-sm-offset-2">
                    <div class="hotel-sd-form">
                        <h2>HÔTELS AVEC</h2>
                        <h2><span style="color:green">400 DESTINATIONS</span></h2>
            ...
            <div class="vamo-module">
                <div class="container">
                    <div class="row">
                        <div class="col-md-12 text-center">
                            <div class="section-title ">
                                <h2>Découvrez nos meilleures destinations</h2>
                                <div class="title-separator-outer ">
                                    <div class="title-separator bg-primary style-liner"></div>
                                </div>
                            </div>
