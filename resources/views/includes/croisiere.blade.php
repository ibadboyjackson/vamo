<form class="content-widget typeahead" role="search" method="post" action="{{ route('recherche.cruise') }}">
    @csrf
    <div class="text-input small-margin-top">
        <div class="place text-box-wrapper">
            ...
            <div class="input-group">
                <input type="search" id="input-search-6" name="q" placeholder="Write the place" class="tb-input" autocomplete="off">
            </div>
        </div>
        <div class="place text-box-wrapper">
            <label class="tb-label"><i class="tb-icon fa fa-map-marker input-group-addon"></i>Arrivé:</label>
            <div class="input-group">
                <input type="search" id="input-search-7" name="p" placeholder="Write the place" class="tb-input" autocomplete="off">
            </div>
        </div>
